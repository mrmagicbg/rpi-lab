...
Notes: Use GDO0 for raw bitstream if sync fails

TFA Dostmann IT+ IoT (868 MHz)
...
Notes: Use packet mode first, fallback to async if decoding fails
*/
